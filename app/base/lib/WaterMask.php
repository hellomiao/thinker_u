...
class WaterMask{
    ...
    private function waterposStr() {
        switch($this->pos){
            case 1:
                $this->x = ($this->srcImg_info[0]-$this->waterImg_info[0])-35;
                $this->y = $this->srcImg_info[1]-$this->waterImg_info[1]-15;
                break;
            case 2:
                $this->x = ($this->srcImg_info[0]-$this->waterImg_info[0])-35;
                $this->y = $this->srcImg_info[1]-$this->waterImg_info[1]-65;
                break;
            default:
                $this->x = ($this->srcImg_info[0]-$this->waterImg_info[0])/2;
