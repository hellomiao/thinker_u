            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <?= $form->field($model, 'controller')->dropDownList($controllerId) ?>

                        <?= $form->field($model, 'action')->dropDownList(['请选择']) ?>
...
<script>
    ...
    $(function ($) {
        ...
        $("#adminacl-controller").change(function(){

            var controller = $(this).val();

            $.post("<?=Url::to('acl/get-action');?>",{controller:controller},function(json){

                var options='';
                for(var item in json){
                    options+='<option value="'+item+'">'+json[item]+'</option>'
                }
                $("#adminacl-action").html(options);
        ...
        var acl = {
            ...
            'editUI': function(id) {
                ...
                $.getJSON(url, {id: id}, function(data) {
                    ...
                    $.post("<?=Url::to('acl/get-action');?>",{controller:data.controller},function(json){
