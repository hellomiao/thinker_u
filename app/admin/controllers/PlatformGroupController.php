 ...
 */
class PlatformGroupController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => UserGroup::find()->where(['platform_id'=>0]),
        ]);
    ...
    public function actionSetAcl(){
        ...
        $json =$groupAclModel->getJsonData($id,0);
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if (!$this->commit) {
                ...
                $model->save();
                $msg ="添加平台角色[$model->group_name]成功";
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if (!$this->commit) {
                ...
                $model->save();
                $msg ="编辑平台角色[$model->group_name]成功";
