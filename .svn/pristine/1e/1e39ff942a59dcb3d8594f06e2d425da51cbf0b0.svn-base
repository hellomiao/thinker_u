...
<div class="box-body">
    ...
    echo $form->field($model, 'group_id')->widget(Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\app\home\models\UserGroup::find()->where(['platform_id'=>[0,$this->context->platform_id]])->andWhere(['<>','id',2])->all(),'id','group_name'),
        'options' => ['placeholder' => '请选择用户组...','multiple' => false],
